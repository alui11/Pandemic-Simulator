function bestTurn = formula5(possibleTurns, players, currentPlayer)
...
boardScore(istep) = boardScore(istep) - 5*total3s;
boardScore(istep) = boardScore(istep) - 2*total2s;
boardScore(istep) = boardScore(istep) - 1*total1s;
boardScore(istep) = boardScore(istep) - 5*potentialCascades;
