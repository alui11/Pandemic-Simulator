function bestTurn = formula4(possibleTurns, players, currentPlayer)
...
boardScore(istep) = boardScore(istep) - 15*total3s;
boardScore(istep) = boardScore(istep) - 8*total2s;
boardScore(istep) = boardScore(istep) - 1*total1s;
boardScore(istep) = boardScore(istep) - 15*potentialCascades;
