function bestTurn = formula1(possibleTurns, players, currentPlayer)
...
boardScore(istep) = boardScore(istep) - 20*total3s;
boardScore(istep) = boardScore(istep) - 10*total2s;
boardScore(istep) = boardScore(istep) - 2*total1s;
boardScore(istep) = boardScore(istep) - 20*potentialCascades;
